...
* Dynamic changes with trend extraction techniques
...
* In consumer behaviours (e.g., emotions are trigged from product designs and can facilitate buying decisions; Mahlke, 2008; Bloch, 1995)
...
Affective states refer to **"valenced (good versus bad) states"** (Gross, 2010, p. 212 [`r emo::ji("link")`](https://doi.org/10.1177/1754073910361982)):
...
.center.tiny[There are many types of affective states, including attitudes, moods, and emotions.<br />*Credit: Gross (2010)* [`r emo::ji("link")`](https://doi.org/10.1177/1754073910361982)]

---

# Holistic Definition of Emotions

> Emotion is defined as *“an **episode of interrelated, synchronized changes** in the states of **all or most of the five organismic subsystems** in **response to the evaluation of an external or internal stimulus** event as relevant to major concerns of the organism”.* Scherer (2001, p.93 [`r emo::ji("link")`](https://global.oup.com/academic/product/appraisal-processes-in-emotion-9780195130072))
...
.center.tiny[The dynamic architecture of the component process model.<br />*Credit: Scherer (2009)* [`r emo::ji("link")`](https://doi.org/10.1080/02699930902928969)]

---

# Developement of Affective Computing

Despite the usefulness of the Component Process Model, research on emotions have lead to a "conceptual and definitional chaos" (Buck, 1990, p.330 [`r emo::ji("link")`](https://doi.org/10.1207/s15327965pli0104_15)):
...
|Type        |Measure                          |Tool                             |
|------------|---------------------------------|---------------------------------|
|Invasive    |Electric Activity of Face Muscles|Facial Electromyography (fEMG)   |
|Non-Invasive|Human Observer Visual Recognition|Manual Annotation Software       |
|Non-Invasive|Landmark Spatial Configuration   |Automatic Recognition Classifiers|      
...
.pull-left[
* Directly, by matching Action Units to prototypical expressions of emotions (Emotion coded by the FACS; Ekman, Friesen, & Hager, 2002 [`r emo::ji("link")`](https://www.paulekman.com/facial-action-coding-system/))
...
Eight video clips were taken from the [DynEmo database](https://dynemo.univ-grenoble-alpes.fr/?lang=en) and judged by human observers as expressing happiness, surprise, fear and disgust (expressed by both males and females):
...
Emotions modulate and influence physiological rhythms (Kreibig, Samson, & Gross, 2013 [`r emo::ji("link")`](https://doi.org/10.1111/psyp.12064)):
...
.center.tiny[Simulation of multivariate physiological measures (5S) including Heart Rate (HR), Breathing Rate (BR), Skin Temperature (ST) and Skin Conductance Level (SCL). All measures are centred and scaled.]
...
Multivariate physiological analysis of emotions during a mountain biking experience (Dupré, Bland, Bolster, Morrison, & McKeown, 2017 [`r emo::ji("link")`](https://doi.org/10.1007/978-3-319-60822-8_4))
...
```{r out.width="60%"}
knitr::include_graphics("media/fail_face_recognition.png")
```
.center.tiny[*Credit: Oddee.com* [`r emo::ji("link")`](https://www.oddee.com/item_98248.aspx)]
...
- Vibrations
- Correct positioning
- Singular genetic predispositions (e.g., sudation level, situs inversus)
]
...
.pull-left[
* Academic benchmarks (e.g., Bent, Goldstein, Kibbe, & Dunn, 2020 [`r emo::ji("link")`](https://doi.org/10.1038/s41746-020-0226-6)) are used to support legal class-actions over misled consumers on the ability of accurately monitoring physiological changes (Sawyer, 2019 [`r emo::ji("link")`](https://doi.org/10.1080/07303084.2019.1649563))

* According a benchmark of 8 commercially available systems, the accuracy of automatic classifiers of facial expressions varies between 48% and 62% (Dupré, Krumhuber, Küster, & McKeown, 2020 [`r emo::ji("link")`](https://doi.org/10.1371/journal.pone.0231968))
]

.pull-right[
```{r out.width="100%"}
tweet_screenshot(
  tweet_url("AI__TECH", "1255878089986338816"),
  maxwidth = 300,
  hide_media = FALSE,
  theme = "dark"
  )
...
Lack of diversity when using facial expression databases with Western/White, Educated, Industrialized, Rich, and Democratic participants (Arnett, 2008 [`r emo::ji("link")`](https://doi.org/10.1037/0003-066X.63.7.602); Raji & Buolamwini, 2019, [`r emo::ji("link")`](https://doi.org/10.1145/3306618.3314244)).

Factors influencing the accuracy to recognize emotion (e.g., Bryant & Howard, 2019 [`r emo::ji("link")`](https://doi.org/10.1145/3306618.3314284); Rhue, 2018 [`r emo::ji("link")`](http://dx.doi.org/10.2139/ssrn.3281765)):
- Identity
- Gender
- Ethnicity
- Age
...
Brackeen, 2017 [`r emo::ji("link")`](https://www.kairos.com/blog/we-ve-retired-our-diversity-recognition-app-here-s-why)
...
Examples of athletes' victory (e.g., raging or crying after wining; see Martinez, 2019 [`r emo::ji("link")`](https://doi.org/10.1073/pnas.1902661116))
...
.pull-left[
* No one-to-one mapping between patterns and categories (Kappas, 2003 [`r emo::ji("link")`](https://doi.org/10.1007/978-1-4615-1063-5_11))
* Facial expression often communicates something other than an emotional state (Barrett, Adolphs, Marsella, Martinez , & Pollak, 2019 [`r emo::ji("link")`](https://doi.org/10.1177/1529100619832930))
]

.pull-right[
```{r out.width="100%"}
tweet_screenshot(
  tweet_url("truthbegolduk", "1152169980722655232"),
  maxwidth = 400,
  hide_media = FALSE,
  theme = "dark"
  )
...
> *"Regulators should ban the use of affect recognition in important decisions that impact people's lives and access to opportunities. Until then, AI companies should stop deploying it."* AI Now 2019 Report [`r emo::ji("link")`](https://ainowinstitute.org/AI_Now_2019_Report.html)

---

# Future Directions

Warning, do not throw the baby out with the bathwater! "All models are wrong, but some are useful" (Box)

.pull-left[
The errors in face and physiological measures are reducing with improved techniques and materials.
...
```{r out.width="100%"}
tweet_screenshot(
  tweet_url("DigitalTrends", "1184388139395108864"),
  maxwidth = 400,
  hide_media = FALSE,
  theme = "dark"
  )
