...
```
.center.tiny[*Credit: Picard (2000)* [`r emo::ji("link")`](https://mitpress.mit.edu/books/affective-computing)]
]
...
# No Evidence of Emotion Categories

Despite the availability of automatic classifiers, there is no scientific evidence of reliable expressive and physiological patterns corresponding to emotional categories

* No one-to-one mapping (Kappas, 2003 [`r emo::ji("link")`](https://doi.org/10.1007/978-1-4615-1063-5_11))
